...
class Car {
  ...
  public printCar(element: HTMLElement) {
    ...
    element.innerHTML += `<div class="entry">
                ...
                <div class="entry_parameter">${this.date
                  .toISOString()
                  .slice(0, 10)}</div>
                ...
                <div class="actions">
                    <img class="edit" onclick='onUpdateCar(${
                      this.id
                    })' src='./img/edit.png' alt="Atnaujinti">
                    <img class="delete" onclick='onDeleteCar(${
                      this.id
                    })' src="./img/delete.png" alt="Istrinti">
                </div>
            </div>`;
  }
}
...
addButton?.addEventListener('click', (e) => {
  if (
    ...
    alert('ERROR, tusti laukai negali buti!');
    return;
  }
...
function hybridCarsList() {
  publishCars(KuroTipas.Hibridas);
}
